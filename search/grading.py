...
class Grades:
    ...
    def grade(self, gradingModule, exceptionMap={}, bonusPic=False):
        ...
        timedOutQuestions = set(
            []
        )  # The set of questions for which the autograder timed out, used to print at the end
...
"""
            ...
            try:
                ...
                util.TimeoutFunction(getattr(gradingModule, q), timeout)(
                    self
        ...
        for q in self.questions:
            print(
                ...
                % (
                    ...
                    self.points[q],
                    self.maxes[q],
                    "program timed out" if q in timedOutQuestions else "",
                )
            )
        print("------------------")
